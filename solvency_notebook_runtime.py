...
QUERY_SYNONYMS = {
    ...
    "usp": [
        ...
        "undertaking specific parameter",
        "undertaking specific parameters",
        "paramètre spécifique à l'entreprise",
        "paramètres spécifiques à l'entreprise",
        "parametre specifique a l'entreprise",
...
SOLVENCY_SCOPE_TERMS = {
    ...
    "long term guarantee",
    "mesures de garantie de long terme",
    "mesures de garanties de long terme",
    "fonds propres",
    ...
    "scr groupe",
    "scr de groupe",
    "exigence de capital de groupe",
    "exigence de capital du groupe",
    "methode de consolidation",
    "methode 1",
    "consolidation",
    "consolide",
    "consolidee",
    "deduction-agregation",
    "deduction aggregation",
    "deduction et agregation",
    "methode de deduction-agregation",
    "methode deduction-agregation",
    "methode 2",
    ...
    "loss-absorbing capacity of deferred taxes",
    "capacite d'absorption des pertes des impots differes",
    "capacite d absorption des pertes des impots differes",
    "undertaking-specific parameter",
    "undertaking-specific parameters",
    "undertaking specific parameter",
    "undertaking specific parameters",
    "parametre specifique a l",
    "parametres specifiques a l",
    "parametre specifique a l'entreprise",
    "parametres specifiques a l'entreprise",
    "parametre propre a l",
    "parametres propres a l",
    "parametre propre a l'entreprise",
    "parametres propres a l'entreprise",
    "orsa",
    "ersa",
    "sfcr",
    "rsr",
    ...
    "action non cotee",
    "actions non cotees",
    "investissement non cote",
    "investissements non cotes",
    "unlisted asset",
    "unlisted assets",
    "unlisted equity",
    "unlisted equities",
    ...
    "p&l attribution",
    "pnl attribution",
    "attribution des profits et pertes",
